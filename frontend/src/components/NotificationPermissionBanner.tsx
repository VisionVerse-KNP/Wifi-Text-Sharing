...
export default function NotificationPermissionBanner() {
  ...
  return (
    <div className="fixed bottom-20 sm:bottom-4 left-1/2 -translate-x-1/2 z-40 glass-card px-4 py-3 flex items-center gap-3 max-w-sm w-[calc(100%-2rem)] animate-slide-up">
